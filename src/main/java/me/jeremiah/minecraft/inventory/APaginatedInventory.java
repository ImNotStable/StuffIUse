 ...
 * @version 1.0.0
 */
public class APaginatedInventory extends AnInventory {
     ...
     */
    public APaginatedInventory(int size) {
     ...
     */
    public APaginatedInventory(int size, Component title) {
     ...
     */
    public APaginatedInventory(InventoryType type) {
     ...
     */
    public APaginatedInventory(InventoryType type, Component title) {
        this(owner -> Bukkit.createInventory(owner, type, title));
    }

    public APaginatedInventory(Function<APaginatedInventory, Inventory> inventoryFunction) {
        super(inv -> inventoryFunction.apply((APaginatedInventory) inv));
